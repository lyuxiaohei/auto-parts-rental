...
window.NOTES_DATA = {
  ...
  "基础数据/库位档案.html": [
    {
      ...
      "title": "库位档案",
      "note": "库位两级＝库位（仓区）＋库位编码（D-102 去库区层级·2026-09-14 第4次沟通）；2026-09-17 收口：库位列取库区命名（原料区 RA/成品区 RB/外购区 RW/次品区 RC），实际损耗走次品区 RC 锁定不参与拣货（D-101）；库区层级后续做大了再加",
      "fp": "FP1-06",
      "req": "REQ-04"
    }
  ],
  ...
  "租入管理/租入入库列表.html": [
    {
      "selector": "<span class=\"form-label\">立即转租</span>",
      "title": "立即转租（背靠背）",
      "note": "D-105（2026-09-14 沈总裁定）：租入入库登记同时可勾选立即转租——供应商直发终端客户，自动生成租赁出库单（自动带物料·免重复填单·租赁出库列表可查该单 CK-20260914-023）；自有+租入混合出库待严工问领导；计费口径待 D-122 梳理拍板",
      "fp": "FP2-01",
      "req": "REQ-02",
      "id": 1
    }
