...
window.DEMO_DATA = {
  ...
  stocktakes: {
    ...
    'PD-202608-02': {
      'row': {"fields": {"scope": "成品区 RB · 组装暂存（RD-01 / RD-02）", "caliber": "正常", "status": "待审核", "checker": "林国栋", "date": "2026-08-15", "createdAt": "2026-08-01"}, "cells": ["成品区 RB · 组装暂存（RD-01 / RD-02）", "<span class=\"tag tag-green\">正常</span>", "<span class=\"td-num\">36</span>", "<span class=\"td-num\" style=\"color:var(--primary)\">+18</span>", "<span class=\"lk\">QTRK-20260816-023</span> <a class=\"docs-plus\">1</a>", "<span class=\"tag tag-orange\">待审核</span>", "林国栋", "2026-08-15", "2026-08-01"], "ops": [{"t": "详情", "act": "go('../仓储作业/盘点详情.html?id=PD-202608-02')"}, {"t": "录入", "act": "go('../仓储作业/盘点录入.html')"}, {"t": "审核", "act": "go('../仓储作业/盘点审核.html?id=PD-202608-02')"}]},
      'title': '盘点单详情',
      'formTitle': '基本信息',
      'formRows': [
