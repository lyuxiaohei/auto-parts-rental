 ...
 * ------------------------------------------------------------------------ */
  opLogs: {
    ...
    'LOG-20260909-0899': { 'row': {"fields": {"user": "袁明（客户账号）", "module": "销售管理", "opType": "新增", "time": "2026-09-09 14:05:37", "summary": "提交销售订单 SO-20260909-0045（ZH-2601-A × 160 套）"}, "cells": ["2026-09-09 14:05:37", "袁明（客户账号）", "销售管理", "<span class=\"tag tag-blue\">新增</span>", "提交销售订单 SO-20260909-0045（ZH-2601-A × 160 套）", "112.18.*.*", "<span class=\"tag tag-green\">成功</span>"]} },
    ...
    'LOG-20260908-0881': { 'row': {"fields": {"user": "路凯对接（供应商账号）", "module": "仓储管理", "opType": "编辑", "time": "2026-09-08 10:18:44", "summary": "回执租入库单 RZ-20260905-004 发货明细（围板箱 300 只）"}, "cells": ["2026-09-08 10:18:44", "路凯对接（供应商账号）", "仓储管理", "<span class=\"tag tag-blue\">编辑</span>", "回执租入库单 RZ-20260905-004 发货明细（围板箱 300 只）", "58.34.*.*", "<span class=\"tag tag-green\">成功</span>"]} },
 ...
 *   fields: search(账号+姓名 联合模糊)/role/side/scope/status；stab=所属方（stabField:side）
 * ------------------------------------------------------------------------ */
  users: {
    'admin': { 'row': {"fields": {"search": "admin 系统管理员", "role": "系统管理员", "side": "我方", "scope": "全部数据", "status": "启用"}, "cells": ["系统管理员", "<span class=\"tag tag-blue\">系统管理员</span>", "<span class=\"tag tag-blue\">我方</span>", "全部数据", "138****0001", "<span class=\"tag tag-green\">启用</span>", "2026-09-10 09:12"], "ops": [{"t": "编辑", "act": "openModal('createModal')"}, {"t": "权限配置", "act": "openModal('roleModal')"}, {"t": "重置密码", "act": "openModal('resetModal')"}, {"t": "停用", "act": "openModal('stopModal')"}]} },
    'wangqiang': { 'row': {"fields": {"search": "wangqiang 王强", "role": "商务主管", "side": "我方", "scope": "全部数据", "status": "启用"}, "cells": ["王强", "<span class=\"tag tag-blue\">商务主管</span>", "<span class=\"tag tag-blue\">我方</span>", "全部数据", "139****0102", "<span class=\"tag tag-green\">启用</span>", "2026-09-10 08:40"], "ops": [{"t": "编辑", "act": "openModal('createModal')"}, {"t": "权限配置", "act": "openModal('roleModal')"}, {"t": "重置密码", "act": "openModal('resetModal')"}, {"t": "停用", "act": "openModal('stopModal')"}]} },
    'chenjin': { 'row': {"fields": {"search": "chenjin 陈金", "role": "商务", "side": "我方", "scope": "华东区", "status": "启用"}, "cells": ["陈金", "<span class=\"tag tag-blue\">商务</span>", "<span class=\"tag tag-blue\">我方</span>", "华东区", "137****2031", "<span class=\"tag tag-green\">启用</span>", "2026-09-09 18:22"], "ops": [{"t": "编辑", "act": "openModal('createModal')"}, {"t": "权限配置", "act": "openModal('roleModal')"}, {"t": "重置密码", "act": "openModal('resetModal')"}, {"t": "停用", "act": "openModal('stopModal')"}]} },
    'lijing': { 'row': {"fields": {"search": "lijing 李静", "role": "财务主管", "side": "我方", "scope": "全部数据", "status": "启用"}, "cells": ["李静", "<span class=\"tag tag-blue\">财务主管</span>", "<span class=\"tag tag-blue\">我方</span>", "全部数据", "136****3345", "<span class=\"tag tag-green\">启用</span>", "2026-09-10 09:05"], "ops": [{"t": "编辑", "act": "openModal('createModal')"}, {"t": "权限配置", "act": "openModal('roleModal')"}, {"t": "重置密码", "act": "openModal('resetModal')"}, {"t": "停用", "act": "openModal('stopModal')"}]} },
    'liguodong': { 'row': {"fields": {"search": "liguodong 李国栋", "role": "物流主管", "side": "我方", "scope": "华东区", "status": "启用"}, "cells": ["李国栋", "<span class=\"tag tag-blue\">物流主管</span>", "<span class=\"tag tag-blue\">我方</span>", "华东区", "135****4567", "<span class=\"tag tag-green\">启用</span>", "2026-09-10 08:15"], "ops": [{"t": "编辑", "act": "openModal('createModal')"}, {"t": "权限配置", "act": "openModal('roleModal')"}, {"t": "重置密码", "act": "openModal('resetModal')"}, {"t": "停用", "act": "openModal('stopModal')"}]} },
    'zhaolei': { 'row': {"fields": {"search": "zhaolei 赵磊", "role": "物流", "side": "我方", "scope": "华东中心仓", "status": "停用"}, "cells": ["赵磊", "<span class=\"tag tag-blue\">物流</span>", "<span class=\"tag tag-blue\">我方</span>", "华东中心仓", "133****5689", "<span class=\"tag tag-gray\">停用</span>", "2026-08-30 17:44"], "ops": [{"t": "编辑", "act": "openModal('createModal')"}, {"t": "权限配置", "act": "openModal('roleModal')"}, {"t": "重置密码", "act": "openModal('resetModal')"}, {"t": "停用", "act": "openModal('stopModal')"}]} },
    'yuanning': { 'row': {"fields": {"search": "yuanning 袁明", "role": "客户账号", "side": "客户", "scope": "一汽解放可见", "status": "启用"}, "cells": ["袁明", "<span class=\"tag tag-blue\">客户账号</span>", "<span class=\"tag tag-blue\">客户</span>", "一汽解放可见", "139****6781", "<span class=\"tag tag-green\">启用</span>", "2026-09-09 16:08"], "ops": [{"t": "编辑", "act": "openModal('createModal')"}, {"t": "权限配置", "act": "openModal('roleModal')"}, {"t": "重置密码", "act": "openModal('resetModal')"}, {"t": "停用", "act": "openModal('stopModal')"}]} },
    'zhangwei': { 'row': {"fields": {"search": "zhangwei 张伟", "role": "客户账号", "side": "客户", "scope": "一汽解放可见", "status": "启用"}, "cells": ["张伟", "<span class=\"tag tag-blue\">客户账号</span>", "<span class=\"tag tag-blue\">客户</span>", "一汽解放可见", "138****6782", "<span class=\"tag tag-green\">启用</span>", "2026-09-08 11:26"], "ops": [{"t": "编辑", "act": "openModal('createModal')"}, {"t": "权限配置", "act": "openModal('roleModal')"}, {"t": "重置密码", "act": "openModal('resetModal')"}, {"t": "停用", "act": "openModal('stopModal')"}]} },
    'liuyang': { 'row': {"fields": {"search": "liuyang 刘洋", "role": "客户账号", "side": "客户", "scope": "东风锂电可见", "status": "启用"}, "cells": ["刘洋", "<span class=\"tag tag-blue\">客户账号</span>", "<span class=\"tag tag-blue\">客户</span>", "东风锂电可见", "137****6783", "<span class=\"tag tag-green\">启用</span>", "2026-09-07 14:50"], "ops": [{"t": "编辑", "act": "openModal('createModal')"}, {"t": "权限配置", "act": "openModal('roleModal')"}, {"t": "重置密码", "act": "openModal('resetModal')"}, {"t": "停用", "act": "openModal('stopModal')"}]} },
    'wanghong': { 'row': {"fields": {"search": "wanghong 王虹", "role": "客户账号", "side": "客户", "scope": "东风锂电可见", "status": "启用"}, "cells": ["王虹", "<span class=\"tag tag-blue\">客户账号</span>", "<span class=\"tag tag-blue\">客户</span>", "东风锂电可见", "136****6784", "<span class=\"tag tag-green\">启用</span>", "2026-09-06 09:33"], "ops": [{"t": "编辑", "act": "openModal('createModal')"}, {"t": "权限配置", "act": "openModal('roleModal')"}, {"t": "重置密码", "act": "openModal('resetModal')"}, {"t": "停用", "act": "openModal('stopModal')"}]} },
    'lukai-s01': { 'row': {"fields": {"search": "lukai-s01 路凯对接", "role": "供应商账号", "side": "供应商", "scope": "路凯包装可见", "status": "启用"}, "cells": ["路凯对接", "<span class=\"tag tag-blue\">供应商账号</span>", "<span class=\"tag tag-blue\">供应商</span>", "路凯包装可见", "135****9012", "<span class=\"tag tag-green\">启用</span>", "2026-09-09 10:18"], "ops": [{"t": "编辑", "act": "openModal('createModal')"}, {"t": "权限配置", "act": "openModal('roleModal')"}, {"t": "重置密码", "act": "openModal('resetModal')"}, {"t": "停用", "act": "openModal('stopModal')"}]} },
    'huasu-s01': { 'row': {"fields": {"search": "huasu-s01 华塑对接", "role": "供应商账号", "side": "供应商", "scope": "华塑包装可见", "status": "启用"}, "cells": ["华塑对接", "<span class=\"tag tag-blue\">供应商账号</span>", "<span class=\"tag tag-blue\">供应商</span>", "华塑包装可见", "133****9013", "<span class=\"tag tag-green\">启用</span>", "2026-09-05 15:02"], "ops": [{"t": "编辑", "act": "openModal('createModal')"}, {"t": "权限配置", "act": "openModal('roleModal')"}, {"t": "重置密码", "act": "openModal('resetModal')"}, {"t": "停用", "act": "openModal('stopModal')"}]} },
  },
