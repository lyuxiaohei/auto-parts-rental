 ...
 * ------------------------------------------------------------------------ */
  projects: {
    'PRJ-2601': { 'row': {"fields": {"name": "一汽解放·长春基地 驾驶室围板箱租赁", "customer": "一汽解放汽车有限公司", "supplier": "路凯包装运营（上海）", "status": "进行中", "start": "2026-01-01", "end": "2027-12-31", "owner": "王强"}, "keyHtml": "<span class=\"lk\" onclick=\"go('../项目管理/项目详情.html')\">PRJ-2601</span>", "cells": ["一汽解放·长春基地 驾驶室围板箱租赁", "一汽解放汽车有限公司", "路凯包装运营（上海）", "<span class=\"tag tag-blue\">进行中</span>", "2026-01-01 ~ 2027-12-31", "王强"], "ops": [{"t": "详情", "act": "go('../项目管理/项目详情.html')"}, {"t": "上下游绑定", "act": "openModal('bindModal')"}]} },
    'PRJ-2602': { 'row': {"fields": {"name": "一汽解放·青岛基地 保险杠料架租赁", "customer": "一汽解放汽车有限公司（青岛）", "supplier": "自购 + 路凯混合", "status": "进行中", "start": "2026-03-15", "end": "2027-06-30", "owner": "陈金"}, "keyHtml": "<span class=\"lk\" onclick=\"go('../项目管理/项目详情.html')\">PRJ-2602</span>", "cells": ["一汽解放·青岛基地 保险杠料架租赁", "一汽解放汽车有限公司（青岛）", "自购 + 路凯混合", "<span class=\"tag tag-blue\">进行中</span>", "2026-03-15 ~ 2027-06-30", "陈金"], "ops": [{"t": "详情", "act": "go('../项目管理/项目详情.html')"}, {"t": "上下游绑定", "act": "openModal('bindModal')"}]} },
    'PRJ-2603': { 'row': {"fields": {"name": "东风锂电·电池包周转箱租赁", "customer": "东风锂电科技", "supplier": "路凯包装运营（上海）", "status": "进行中", "start": "2026-05-01", "end": "2027-04-30", "owner": "王强"}, "keyHtml": "<span class=\"lk\" onclick=\"go('../项目管理/项目详情.html')\">PRJ-2603</span>", "cells": ["东风锂电·电池包周转箱租赁", "东风锂电科技", "路凯包装运营（上海）", "<span class=\"tag tag-blue\">进行中</span>", "2026-05-01 ~ 2027-04-30", "王强"], "ops": [{"t": "详情", "act": "go('../项目管理/项目详情.html')"}, {"t": "上下游绑定", "act": "openModal('bindModal')"}]} },
    'PRJ-2604': { 'row': {"fields": {"name": "上汽通用五菱·座椅周转箱租赁（试点）", "customer": "上汽通用五菱", "supplier": "华塑包装制品", "status": "已暂停", "start": "2026-06-10", "end": "2026-12-31", "owner": "陈金"}, "keyHtml": "<span class=\"lk\" onclick=\"go('../项目管理/项目详情.html')\">PRJ-2604</span>", "cells": ["上汽通用五菱·座椅周转箱租赁（试点）", "上汽通用五菱", "华塑包装制品", "<span class=\"tag tag-orange\">已暂停</span>", "2026-06-10 ~ 2026-12-31", "陈金"], "ops": [{"t": "详情", "act": "go('../项目管理/项目详情.html')"}, {"t": "上下游绑定", "act": "openModal('bindModal')"}]} },
    'PRJ-2605': { 'row': {"fields": {"name": "一汽解放·蔚山基地 围板箱租赁扩建", "customer": "一汽解放汽车有限公司", "supplier": "路凯包装运营（上海）", "status": "筹备中", "start": "2026-10-01", "end": "2028-03-31", "owner": "王强"}, "keyHtml": "<span class=\"lk\" onclick=\"go('../项目管理/项目详情.html')\">PRJ-2605</span>", "cells": ["一汽解放·蔚山基地 围板箱租赁扩建", "一汽解放汽车有限公司", "路凯包装运营（上海）", "<span class=\"tag tag-gray\">筹备中</span>", "2026-10-01 ~ 2028-03-31", "王强"], "ops": [{"t": "详情", "act": "go('../项目管理/项目详情.html')"}, {"t": "上下游绑定", "act": "openModal('bindModal')"}]} },
    'PRJ-2606': { 'row': {"fields": {"name": "东风锂电·二期 电池包周转箱扩容", "customer": "东风锂电科技", "supplier": "路凯包装运营（上海）", "status": "筹备中", "start": "2026-11-01", "end": "2028-06-30", "owner": "王琳"}, "keyHtml": "<span class=\"lk\" onclick=\"go('../项目管理/项目详情.html')\">PRJ-2606</span>", "cells": ["东风锂电·二期 电池包周转箱扩容", "东风锂电科技", "路凯包装运营（上海）", "<span class=\"tag tag-gray\">筹备中</span>", "2026-11-01 ~ 2028-06-30", "王琳"], "ops": [{"t": "详情", "act": "go('../项目管理/项目详情.html')"}, {"t": "上下游绑定", "act": "openModal('bindModal')"}]} },
    'PRJ-2599': { 'row': {"fields": {"name": "上汽大众·南京工厂 托盘租赁（已完结）", "customer": "上汽大众", "supplier": "华塑包装制品", "status": "已完结", "start": "2025-06-01", "end": "2026-05-31", "owner": "陈金"}, "keyHtml": "<span class=\"lk\" onclick=\"go('../项目管理/项目详情.html')\">PRJ-2599</span>", "cells": ["上汽大众·南京工厂 托盘租赁（已完结）", "上汽大众", "华塑包装制品", "<span class=\"tag tag-green\">已完结</span>", "2025-06-01 ~ 2026-05-31", "陈金"], "ops": [{"t": "详情", "act": "go('../项目管理/项目详情.html')"}, {"t": "上下游绑定", "act": "openModal('bindModal')"}]} },
    'PRJ-2598': { 'row': {"fields": {"name": "吉利汽车·西安基地 料箱租赁（已完结）", "customer": "吉利汽车", "supplier": "华塑包装制品", "status": "已完结", "start": "2025-03-01", "end": "2026-02-28", "owner": "李国栋"}, "keyHtml": "<span class=\"lk\" onclick=\"go('../项目管理/项目详情.html')\">PRJ-2598</span>", "cells": ["吉利汽车·西安基地 料箱租赁（已完结）", "吉利汽车", "华塑包装制品", "<span class=\"tag tag-green\">已完结</span>", "2025-03-01 ~ 2026-02-28", "李国栋"], "ops": [{"t": "详情", "act": "go('../项目管理/项目详情.html')"}, {"t": "上下游绑定", "act": "openModal('bindModal')"}]} },
  },
